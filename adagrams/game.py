...
def get_highest_word_score(word_list):
    ...
    #     words_and_scores[score_word(word)] = word
    #     scores_list.append(score_word(word))

    # top_score = max(scores_list)
    
    # #there's a tie
    # if scores_list.count(top_score) > 1:

    #     #sort list with shortest word first
    #     for score, word in words_and_scores.items():
    #         if score == top_score:
    #             tied_words.append(word)
        
    #     sorted_tied_words = sorted(tied_words, key=len)
       
    #     for word in words_and_scores.values():
    #         if len(word) == 10:
    #             return word, score_word(word)
    #         else:
    #             return sorted_tied_words[0], top_score

    # else:
    #     return words_and_scores[top_score], top_score
